...
尺寸估算规则（非常重要）：
  ...
  - **所有维度必须在 1~48 之间**（Minecraft 结构方块加载上限）。如果估算超过 48，缩减到 48 以内。

字段说明：
- building_type: 建筑类型，如 "house", "tower", "church", "bridge", "villa", "skyscraper", "temple", "castle", "barn", "warehouse", "school", "pagoda"
- height: 总高度（格），整数 1-48
- width: 宽度（格），整数 1-48
- length: 深度（格），整数 1-48
- shape: 建筑平面形状，如 "rectangle", "L", "cross", "T", "U"
- style: 建筑风格，如 "modern", "gothic", "classical", "asian", "medieval", "brutalist", "renaissance", "victorian", "colonial"
